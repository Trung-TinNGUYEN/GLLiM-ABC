...
## modg obtained via GLLiM with N=10^5
#modgllimNLMIIDFullK1N105<-gllimIIDK1(nlmparams2[,1:10^5], nlmdata2[,1:10^5],100, cstr=list(Sigma=""),verb=0)

# other test with modg<-modgllimNLMIIDFullK1N102
